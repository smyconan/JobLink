            ...
            <ul>  
                <?php
                    ...
                    if (!$con) {
                        ...
                        //$sql = "select n.jid as jid, c.cname as cname, j.title as title, n.nfstatus as nfstatus, n.nftime as time
                        //        from notification n, joba j, company c
                        //        where n.jid = j.jid and n.cid = j.cid and n.cid = c.cid and n.sid = ?";
                        $sql = "select a.sid as sid, s.realname as realname, j.title as title, a.apstatus as status, a.aptime as time
                                from application a, joba j, student s
                                where a.jid = j.jid and a.cid = j.cid and a.sid = s.sid and a.cid = ?";
                        ...
                        foreach ($rows as $row) {
                            if ($row[3] == 'unread') {
                                echo "<li><a href='studentShow.php?id=".$row[0]."'>
                                        <b>".$row[2]." ".$row[1]."</b><br>
                                        ".$row[4]."
                                      </a></li>";
                            } else {
                                echo "<li><a href='studentShow.php?id=".$row[0]."'>".$row[1]." ".$row[2]."<br>".$row[4]."</a></li>";
                            }
                        }
